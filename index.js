...
function prompt2WashroomAdvOne() {
    ...
    startprompt.innerHTML = "Great! You go to the washroom.";
    startprompt.style.width = "98vw";
    startprompt.style.position = "absolute";
    var quest = document.createElement("p");
    quest.innerHTML = "You enter the washroom hoping that inspiration for a plan to get the code strikes you at any moment. But you stand there for a solid minute, nothing coming to you. Then you hear something at the door. Knocking. They can't see you. You're supposed to be gone. So you basically only have two options: hide in a stall or climb out of the window.<br><br>";
    quest.style.width = "98vw";
    quest.style.position = "absolute";
    var startpromptlabel = document.createElement("label");
    startpromptlabel.htmlFor = "startresponse";
...
function advOneHideRobots(from) {
    var startprompt = document.getElementById("startprompt");
    if (from==="fromhall"){
        startprompt.innerHTML = "Great! You go to the hallway, but there are some robots, so you hide along the wall, being sure not to move.";
    } else if (from==="fromwash"){
        startprompt.innerHTML = "Great! You choose to hide from the robots in the stall.";
    }
    startprompt.style.width = "98vw";
    startprompt.style.position = "absolute";
    var quest = document.createElement("p");
    quest.innerHTML = "While you hide, you overhear the robots talking. You ignore it at first, but the word 'code' piques your interest. And you hear them say something about the code being on the computer in the owner's office. So should you go to the office? Or maybe you should go back to your desk and think before doing anything? Or maybe running away is the best idea?<br><br>";
    quest.style.width = "98vw";
    quest.style.position = "absolute";
    var startpromptlabel = document.createElement("label");
    startpromptlabel.htmlFor = "startresponse";
